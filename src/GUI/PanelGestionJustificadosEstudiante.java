	...
	public PanelGestionJustificadosEstudiante() {
		...
		btnBaja.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				//con esta condicional nos aseguramos que solo se puedan eliminar los que a�n
				//no hayan sido tocados por un analista
				if(justificadoDB.getEstado().equals("INGRESADO")) {
					
					//Se le adjudica el justificado obtenido desde la base a la variable static "justificado" y se lanza el pop up de confirmaci�n
					...
					//JOptionPane.showMessageDialog(null, "Justificado dado de baja con �xito", null,
