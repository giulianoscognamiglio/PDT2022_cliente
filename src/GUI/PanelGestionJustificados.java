		...
		btnBaja.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(null, "Justificacion dado de baja con �xito", null,
		...
		btnActualizar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				justificadoDB.setEstado(estado);
					...
					String stringDetalle = "La justificaci�n con ID " + justificadoDB.getId_justificado() + " pas� de estar " + justificadoDB.getEstado() + " a estar " + comboBox.getSelectedItem();
...
////////////////////////////////////////////////////////////////////////////////////////
	...
	private DefaultComboBoxModel cargarComboFiltroValor(String criterio) throws ServiciosException {
		// m�todo para hacer aparecer el comboBoxFiltroCriterio y darle los datos a
		// mostrar
		DefaultComboBoxModel modeloCombo = new DefaultComboBoxModel();
