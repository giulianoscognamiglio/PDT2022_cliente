...
public class ConfirmacionPopUp extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ConfirmacionPopUp frame = new ConfirmacionPopUp();
	...
	public ConfirmacionPopUp() {
		...
		btnRegistrarse.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					DAOGeneral.reclamoBean.borrar(reclamo.getId_reclamo());
					
					JOptionPane.showMessageDialog(null, "Reclamo eliminado con éxito", null, JOptionPane.PLAIN_MESSAGE);
		...
		JLabel lblReclamo = new JLabel("Seguro de que desea eliminar este reclamo?");
